...
models = {
    'Breast_Cancer': pickle.load(open('D:\Medical diagnosis AI\Breast_cancer_model.sav', 'rb')),
    'PCOS': pickle.load(open('D:\Medical diagnosis AI\PCOS_model.sav', 'rb')),
    'Thyroid': pickle.load(open('D:\Medical diagnosis AI\Thyroid_model.sav', 'rb')),
    'Heart_Disease': pickle.load(open('D:\Medical diagnosis AI\Heart_Disease_model.sav', 'rb'))
}
